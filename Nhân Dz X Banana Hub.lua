...
local Tabs = {
    Main = Window:AddTab({ Title = "Cày vật phẩm", Icon = "home" }),
    ...
    Visual = Window:AddTab({ Title = "Troll", Icon = "scan-face" }),
    Race = Window:AddTab({ Title = "Thức tỉnh", Icon = "chevrons-right" }),
...
ImageButton.Image = "rbxassetid://138418640790242"
