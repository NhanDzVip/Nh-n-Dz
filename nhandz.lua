...
if Sea3 then
    local v498 = v16.Kitsune:AddSection("Đảo Cáo");
    ...
    local v500 = v16.Kisune:AddToggle("ToggleEspKitsune", {
...
if Sea3 then
    ...
    local v515 = v16.Leviathan:AddToggle("AutoFindFrozen", {
    ...
    local v516 = v16.Leviathan:AddToggle("AutoComeTiki", {
    ...
    local v517 = v16.Leviathan:AddToggle("AutoComeHydra", {
...
local v66 = v16.Fruit:AddToggle("ToggleTpAdvanced", {
    Title = "Bay Đến Người bán trái cây cao cấp",
    Description = "",
    Default = false
});
...
local v56 = v16.Leviathan:AddSection("Leviathan");
v16.Leviathan:AddButton({
...
local v155 = v16.Leviathan:AddToggle("ToggleTPFrozenDimension", {
...
if Sea3 then
    local v561 = v16.Leviathan:AddParagraph({
